...
const string ServiceName = "api-a";
const string SampleKey = "API_A_SAMPLE_VALUE";
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo
    {
        Title = ServiceName,
        Version = "v1",
        Description = "Public edge API. Shares net-a3 with api-3. Does not share a network with api-4."
    });
});
